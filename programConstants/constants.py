...
class Tests:    
    dummyPrefix = "dummy_" #because gitignore is primed to ignore files and folders starting with this prefix. Helps avoid committing the dummy files generated by test cases
    testFolder = os.path.join("tests", "dummy_folders", "") #The quotes at the end add an OS-specific folder slash